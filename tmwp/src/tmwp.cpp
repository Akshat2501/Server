#include<tmwp>      // included in this file
#include<windows.h>
#include<stdio.h>
#include<stdlib.h>
#include<string.h>
...
if(f==NULL)
{
sprintf(responseBuffer,"HTTP/1.1 200 OK\nContent-Type: text/html\nContent-Length: 182\nConnection: close\n\n<!DOCTYPE HTML><html lang='en'><head><meta charset='utf-8'><title>TMWeb Projector</title></head><body><h2 style='color:red'>Resource hi nhi h bhai...nikal yahan se</h2></body></html>\n");
